...
В реализации используются docx-python, re, oxml
...
|Размер шрифта в приложении                           |Не менее 8                    |***Есть***                |
|Название шрифта в таблицах                           |Arial                         |***Есть***                |
|Название шрифта в теле                               |Arial                         |***Есть***                |
|Название шрифта в приложении                         |Arial                         |***Есть***                |
|Проверка отступов                                    |1.25                          |***Есть***                |
|Проверка ориентации                                  |Книжная                       |***Есть***                |
|Проверка обязательных пустых строк                   |Наличие                       |***Есть***                |
|Проверка размера обязательных пустых строк           |10-12                         |***Есть***                |
|Проверка нумерации страниц                           |Наличие со второй             |***Есть***                |
|Проверка места для штрих кода                        |Наличие                       |***Есть***                |
